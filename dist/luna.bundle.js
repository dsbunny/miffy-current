...
const AppManifestSchema = z$1.object({
    name: z$1.string(),
    description: z$1.string(),
    version: z$1.string(),
    author: z$1.string(),
    license: z$1.string(),
    showModal: z$1.custom().optional(),
    ConfigSchema: z$1.any().optional(),
    LunaApp: z$1.custom().optional(),
    WebApp: z$1.custom().optional(),
    WebGLApp: z$1.custom().optional(),
});
...
class LunaRenderer extends EventTarget$1 {
...
class LunaPrefetch extends EventTarget$1 {
    constructor() {
        super();
