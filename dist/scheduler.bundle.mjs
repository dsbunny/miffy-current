...
class DateTime$1 {
  ...
  static fromObject(obj, opts = {}) {
    ...
    if (!inst.isValid) {
      return DateTime$1.invalid(inst.invalid);
    }
  ...
  static fromFormatParser(text, formatParser, opts = {}) {
    ...
    if (invalidReason) {
      return DateTime$1.invalid(invalidReason);
    } else {
...
class BasicScheduler extends EventTarget$1 {
    ...
    async _fetch(url) {
        ...
        const json = await parse(referenced, { scope: self.location.href });
        return json;
    }
    async _clear() {
    ...
    async _parseSchedule(json) {
        ...
        for (const decl of json.schedule) {
            if (running_schedules_by_id.has(decl.id)) {
                calendar_schedules.push(running_schedules_by_id.get(decl.id));
