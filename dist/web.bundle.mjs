...
// TBD: Poster.
class WebAsset extends EventTarget$1 {
...
class WebImage extends WebAsset {
    constructor(src, duration, collection) {
...
class WebVideo extends WebAsset {
    constructor(src, duration, collection) {
        super(src, duration, collection);
...
WebPlaylistElement = __decorate([
    t('web-play-list')
], WebPlaylistElement);
var WebPlaylistElement$1 = WebPlaylistElement;

export { WebPlaylistElement$1 as default };
//# sourceMappingURL=web.bundle.mjs.map
