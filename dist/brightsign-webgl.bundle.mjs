...
WebPlaylistElement = __decorate$2([
    t$2('web-play-list')
], WebPlaylistElement);
...
let WebGLPlaylistElement = class WebGLPlaylistElement extends WebPlaylistElement$1 {
    static { this.styles = i$3 `
		:host {
			display: block;
			contain: strict;
...
let BrightSignWebGLPlaylistElement = class BrightSignWebGLPlaylistElement extends WebGLPlaylistElement$1 {
...
BrightSignWebGLPlaylistElement = __decorate([
    t$2('brightsign-webgl-play-list')
], BrightSignWebGLPlaylistElement);
var BrightSignWebGLPlaylistElement$1 = BrightSignWebGLPlaylistElement;

export { BrightSignWebGLPlaylistElement$1 as default };
//# sourceMappingURL=brightsign-webgl.bundle.mjs.map
