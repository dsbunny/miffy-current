...
declare class BrightSignPlaylistElement extends WebPlaylistElement {
    protected _createRenderer(): Renderer;
}
...
declare class BrightSignWebGLPlaylistElement extends WebGLPlaylistElement {
    protected _createRenderer(): Renderer;
}
