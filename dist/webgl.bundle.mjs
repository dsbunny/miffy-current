...
// TBD: Poster.
class ThreeAsset extends EventTarget {
...
class ThreeImage extends ThreeAsset {
    constructor(src, duration, collection) {
    ...
    close() {
        if (this.texture instanceof Texture) {
            this.collection.release(this.texture.image);
    ...
    load() {
        ...
        const img = this.collection.acquire();
...
class ThreeVideo extends ThreeAsset {
    constructor(src, duration, collection) {
        super(src, duration, collection);
    ...
    load() {
        const video = this.collection.acquire();
...
class ThreeApp extends ThreeAsset {
    constructor(src, duration, collection) {
        super(src, duration, collection);
        this._startTime = NaN;
        this._lastTimeUpdate = 0;
...
class ImageCollection$1 extends ThreeCollection {
    constructor(renderRoot) {
        super(renderRoot);
        this._images = [];
    }
...
class VideoCollection$1 extends ThreeCollection {
    constructor(renderRoot) {
        super(renderRoot);
        this._videos = [];
    }
    ...
    createThreeAsset(src, _duration) {
...
class AppCollection extends ThreeCollection {
    constructor(renderRoot, renderer) {
        ...
        this._fbo = new WebGLRenderTarget(width, height, {
...
class ThreeAssetManager {
    ...
    _createCollection(renderTarget, renderer) {
        ...
        const collection = new Map([
            ['HTMLImageElement', new ImageCollection$1(renderTarget)],
            ['HTMLVideoElement', new VideoCollection$1(renderTarget)],
            ['CustomElement', new AppCollection(renderTarget, renderer)],
        ]);
        return collection;
    }
    // decl: { type, href }
...
class WebGLRenderer extends EventTarget {
    ...
    constructor() {
        ...
        this._displacement_texture = new Texture();
        this._empty_texture = new Texture();
        this._network_loading_count = 0;
        this._current_asset = null;
        this._next_asset = null;
        this._shader = new RawShaderMaterial({
            side: DoubleSide,
            transparent: true,
            depthTest: false,
            depthWrite: false,
    ...
    async setStateUnhooked(value) {
        {
            const html = prettyPrint$1(value);
    ...
    _createThreeJSRenderer() {
        ...
        const renderer = new WebGLRenderer$1({ canvas, context });
        return renderer;
    }
    ...
    async _onSchedulerCurrent(current) {
        if (current !== null) {
            ...
            else if (this._current_asset instanceof RendererAsset$1) {
                this._current_asset = await this._updateCurrent(current.decl);
                this._current_asset.end_time = (typeof current.remainingTimeMs === "number") ?
                    (current.remainingTimeMs + performance.now()) : Number.MAX_SAFE_INTEGER;
            }
    ...
    _onSchedulerNext(next) {
        ...
        if (next !== null) {
            ...
            else if (this._next_asset instanceof RendererAsset$1) {
                this._next_asset = this._updateNext(next.decl);
                this._next_asset.end_time = (typeof next.remainingTimeMs === "number") ?
                    (next.remainingTimeMs + performance.now()) : Number.MAX_SAFE_INTEGER;
            }
    ...
    async _onSchedulerTransition(transition) {
        ...
        if (transition !== null) {
            ...
            if (typeof from_asset !== "undefined"
                ...
                if (this._map1_asset instanceof RendererAsset$1) {
            ...
            if (typeof to_asset !== "undefined"
                ...
                if (this._map2_asset instanceof RendererAsset$1) {
    ...
    async _updateCurrent(decl) {
        ...
        if (typeof asset === "undefined") {
            ...
            const new_asset = new RendererAsset$1(decl.id, media_asset);
    ...
    async _updateCurrentFromNext() {
        ...
        this._next_asset = null;
        if (asset instanceof RendererAsset$1
            && asset.readyState >= HTMLMediaElement.HAVE_CURRENT_DATA) {
            await asset.play();
            if (this._isEmptyTexture(this._shader.uniforms.map2.value)) {
                if (this._map1_asset !== null) {
...
let WebGLPlaylistElement = class WebGLPlaylistElement extends CssPlaylistElement$1 {
...
var WebGLPlaylistElement$1 = WebGLPlaylistElement;

export { WebGLPlaylistElement$1 as default };
//# sourceMappingURL=webgl.bundle.mjs.map
