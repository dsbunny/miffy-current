...
export class LunaRenderer extends EventTarget implements Renderer {
	...
	protected _asset_manager = new LunaAssetManager();
	protected _transition_percent = 0;
	protected _transition_percent_speed = 0;
	protected _network_loading_count = 0;
	protected _current_renderer_asset: LunaRendererAsset | null = null;
	protected _next_renderer_asset: LunaRendererAsset | null = null;
	protected _map1_renderer_asset: LunaRendererAsset | null = null;
	protected _map2_renderer_asset: LunaRendererAsset | null = null;
	protected _renderer_asset_cache: Map<string, LunaRendererAsset> = new Map();
	protected _renderer_asset_trash: Map<string, LunaRendererAsset> = new Map();
