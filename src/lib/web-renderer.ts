...
export class WebRenderer extends EventTarget implements Renderer {
	...
	protected _current_asset: WebRendererAsset | null = null;
	protected _next_asset: WebRendererAsset | null = null;
	protected _map1_asset: WebRendererAsset | null = null;
	protected _map2_asset: WebRendererAsset | null = null;
	protected _asset_cache: Map<string, WebRendererAsset> = new Map();
	protected _asset_trash: Map<string, WebRendererAsset> = new Map();
