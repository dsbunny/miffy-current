...
//		console.log('update', timestamp);
	...
	protected _canPaintAsset(asset: RendererAsset): boolean {
...
//	}
	...
	protected _fetchAsset(decl: MediaDecl): RendererAsset {
	...
	protected _updateAsset(asset: RendererAsset): void {
	...
	protected _unbindAsset(asset: RendererAsset): void {
		asset.user_data.ref_count--;
	...
	protected _createRendererAsset(decl: MediaDecl): RendererAsset {
